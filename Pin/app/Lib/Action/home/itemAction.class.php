...
class itemAction extends frontendAction {
    ...
    public function index() {
        ...
        !$id && $this->_404();
        $item_mod = M('item');
        $item = $item_mod->field('id,title,uid,uname,intro,price,url,likes,comments,tag_cache,seo_title,seo_keys,seo_desc,add_time,start_time,end_time,address')->where(array('id' => $id, 'status' => 1))->find();
        !$item && $this->_404();
        //来源
